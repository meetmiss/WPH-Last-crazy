$(function() {
    ...
    $('.R-nav .b9').hover(function() {
        $(this).children('.b10').show();
    },function() {
        $(this).children('.b10').hide();
    });
    // 更多下盒子
    $('.R-nav .b11').hover(function() {
        $(this).children('.a10').show();
    },function() {
        $(this).children('.a10').hide();
    });
    // logo
    // 购物袋下盒子
    ...
    // 商品分类  更多
    $('.a14 .a14-1').hover(function() {
        $(this).children('.a14-2').show();
    },function() {
        $(this).children('.a14-2').hide();
    });
    // 商品分类  下拉菜单
    $('.a14 .b13').hover(function() {
        $(this).children('.b12').stop().slideDown();
    },function() {
        $(this).children('.b12').stop().slideUp();
    });
    // 右侧菜单
