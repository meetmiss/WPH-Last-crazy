  ...
  $(".sellAll").hover(
    function() {
      ...
      $(this)
        ...
        .hide();
      $(this)
        .addClass("mouseenter-sell")
        .children("p")
        .show();
      $(this)
        .find(".arrow-bot")
        .addClass("arrow-top")
        .removeClass("arrow-bot");
    },
    function() {
      $(".wp-order")
        .children("span")
...
$(".detail-all").mouseleave(function () {
  ...
  //   var num = $(this).index() + 1;
  //   $(".detail-all").show();
  //   $(".detail-all .detail:nth-child(" + num + ")")
  //     .show()
  //     .siblings(".detail")
  //     .hide();
  // });
  ...
  function right() {
    ...
    $(".fbc-trigger-con i:nth-child(" + index + ")")
      .addClass("change")
      .siblings()
      .removeClass("change");
  ...
  $(".arrow-l").click(function() {
    ...
    $(".fbc-trigger-conn i:nth-child(" + index + ")")
      .addClass("change")
      .siblings()
      .removeClass("change");
    $(".focus-banner-con ul").css({
    ...
    function() {
      if ($(this).index() <= 1) {
        ...
        $(this)
          ...
          .siblings("div")
          .removeClass("changeBgc1");
        $(".rtTop .box2 div:nth-child(" + index + ")")
          .show()
          .siblings("div")
          .hide();
      }
  ...
  $(".rtTop .box2 > div").hover(
    function() {
      var index = $(this).index() + 1;
      $(".rtTop div:nth-child(" + index + ")")
        .addClass("changeBgc1")
        .siblings("div")
        .removeClass("changeBgc1");
      $(this)
